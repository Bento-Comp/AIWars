...
namespace GameFramework
{
	...
	public class Game : MonoBehaviour 
	{
		...
		public void GameStart()
		{
			...
			Debug.Log("GameFramework : Game : GameStart");
		...
		public void Interlude()
		{
			...
			Debug.Log("GameFramework : Game : Interlude");
		...
		public void InterludeEnd()
		{
			...
			Debug.Log("GameFramework : Game : Interlude End");
		...
		public void GameOver()
		{
			...
			Debug.Log("GameFramework : Game : GameOver");
		...
		public void LevelCompleted(bool success)
		{
			...
			Debug.Log("GameFramework : Game : LevelCompleted : success = " + success);
